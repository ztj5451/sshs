...
import com.yunrong.action.ServerInfoAction;
import com.yunrong.entity.ServerStatus;
import com.yunrong.entity.ServerStatus.CpuInfoVo;
import com.yunrong.entity.ServerStatus.DiskInfoVo;
...
public class Common {
	...
	public static void getServerCpuInfo(Sigar sigar, ServerStatus status) {
		try {
			...
			String cpuu = CpuPerc
					.format(totalUse / status.getCpuInfos().size());
